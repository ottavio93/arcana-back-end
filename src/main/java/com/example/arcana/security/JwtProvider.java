package com.example.arcana.security;
...
import io.jsonwebtoken.Claims; 
  ...
  java.security.*; import java.security.cert.CertificateException; import
  java.sql.Date; import java.time.Instant;

import javax.annotation.PostConstruct;

import static io.jsonwebtoken.Jwts.parser; import static java.util.Date.from;
...
//  @Value("${jwt.expiration.time}") 
  ...
  SpringArcanaException("Exception occurred while loading keystore", e); }
 ...
 // .signWith(getPrivateKey())
  ...
  { throw new
  SpringArcanaException("Exception occured while retrieving public key from keystore"
  , e); } }
  
  public boolean validateToken(String jwt) {
  parser().setSigningKey(getPublickey()).parseClaimsJws(jwt); return true; }
  ...
  SpringArcanaException("Exception occured while " +
  "retrieving public key from keystore", e); } }
  
  public String getUsernameFromJwt(String token) { Claims claims = parser()
  .setSigningKey(getPublickey()) .parseClaimsJws(token) .getBody();
